...
\begin{figure}[h!]
\centering
\begin{tikzpicture}[rounded corners,-{Stealth[length=6pt]}]
\node[draw, align=center,minimum height = 12mm, minimum width=30mm] (working) {Working\\directory};
\node[draw,align=center,minimum height = 12mm, minimum width=30mm,above right = 5mm and 5mm of working] (staging) {Staging\\index};
\node[draw,align=center,minimum height = 12mm, minimum width=30mm,above right = 5mm and 5mm of staging] (local) {Local\\repository};
\node[draw,align=center,minimum height = 12mm, minimum width=30mm,above right = 5mm and 5mm of local] (remote) {Remote\\repository};
...
\draw (remote.230) --++ (270:22mm) -| (local.330) node[pos=.05,anchor=south east]{pull};
\end{tikzpicture}
\end{figure}
